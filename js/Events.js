...
export default function Events() {
  ...
  var buildPage = function () {
    ...
    document
      ...
      .setAttribute("content", gLangMain.meta.desc);
    document
      .querySelector("meta[property=og\\:title]")
      .setAttribute("content", gLangMain.meta.title);
    document
      .querySelector("#logo img")
      .setAttribute("alt", gLangMain.meta.title + " Logo");
    ...
    document.querySelector("header > nav").innerHTML =
      getHeaderContent(gLangMain);
    setupLangMenu(gLang);
    document.getElementsByTagName("footer")[0].innerHTML =
      getFooterContent(gLangMain);
  ...
  var setLanguage = function (callback) {
    ...
    if (gLang === "en")
      import("../data/lang/en/main").then(function () {
        buildPage();
        callback();
      });
    else if (gLang === "de")
      import("../data/lang/de/main").then(function () {
        buildPage();
        callback();
      });
    else return false;
  ...
  function moveFocus(incr, e) {
    ...
    const activeLiPos = [].indexOf.call(
      lis,
