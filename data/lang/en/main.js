...
window.gLangMain = {
  ...
  landing: {
    ...
    license: {
      title: "Usage & License",
      content: 'It\'s free! Please use and learn.<br/> The code of this website is also <a href="https://github.com/serlo/PlantBuddies" title="PlantBuddies – Open Source Companion Planting Tool on GitHub">available</a>!<br/> We want to make the Illustations and the content available with an open license for the final version.'
    },
    github_link_title: "PlantBuddies – Open Source Companion Planting Tool on GitHub",
    contact: {
      title: "Contact, Contribution & Feeback",
      content: 'This project is an early version so please do send your feedback and ideas to <a title="Looking forward to your message!" class="mail">botho [a] serlo [:] org</a> or contribute to <a href="https://github.com/serlo/PlantBuddies" title="PlantBuddies – Open Source Companion Planting Tool on GitHub">this project on GitHub</a>.<br/>Thank you!'
    },
    privacy: {
      title: "Privacy",
